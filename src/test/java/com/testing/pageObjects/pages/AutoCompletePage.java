  ...
  public void setElementValueTo(String elementName, String value){
    switch(elementName){
      ...
      case "MULTIPLE_COLOR_FIELD":
        ...
        e.click();  //getElement(elementName).click();
        e.sendKeys(value);  //etElement(elementName).sendKeys(value);
        e.sendKeys(Keys.ENTER);//getElement(elementName).sendKeys(Keys.ENTER);
